...
import { HarnessScreen } from './components/screens/HarnessScreen';
...
export default function App() {
  const [activeScreen, setActiveScreen] = useState<ActiveScreen>('playground');
        ...
        <div className="flex-1 flex overflow-hidden relative">
          ...
          <main className="flex-1 overflow-y-auto bg-[#FAF8F5] p-4 md:p-6 custom-scrollbar">
            ...
            {activeScreen === 'onboarding' && (
              <FirstRunOnboardingScreen onComplete={() => setActiveScreen('home')} />
            )}
            ...
            {activeScreen === 'harness' && <HarnessScreen />}
