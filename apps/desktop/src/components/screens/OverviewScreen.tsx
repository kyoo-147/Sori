    ...
    <div className="mx-auto max-w-[1180px] space-y-6 p-1 text-[#1C1B19] sm:p-2 md:p-4">
      ...
      <div className="grid gap-5 xl:grid-cols-[minmax(0,1fr)_340px]">
        ...
        <aside className="space-y-5">
          ...
          <section className="rounded-[18px] border border-[rgba(92,84,75,0.13)] bg-[#F2EEE8] p-4"><div className="flex items-start gap-3"><Radio className="mt-0.5 h-4 w-4 text-[#6E7A80]" /><div><h3 className="text-xs font-medium">Runtime status</h3><p className="mt-1 text-[11px] leading-4 text-[#68635D]">{runtimeSource === 'unavailable' || runtimeSource === 'mock' ? 'Daemon unavailable. Microphone, model, hotkey, and injection are UNVERIFIED.' : 'Connected to the local Sori runtime.'}</p></div></div></section>
        </aside>
      </div>
    </div>
  );
