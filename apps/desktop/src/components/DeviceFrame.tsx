...
export const DeviceFrame: React.FC<DeviceFrameProps> = ({ deviceView, children }) => {
  ...
  return (
    <div className="min-h-screen bg-[#F4F1EC] p-2 sm:p-8 flex justify-center items-start overflow-x-auto">
      <div
        className={`w-full ${widthClass} bg-[#FAF8F5] border-2 sm:border-4 border-[#DAD7D0] rounded-[20px] sm:rounded-[32px] shadow-xl overflow-hidden min-h-[700px] flex flex-col transition-all duration-300 relative`}
      >
