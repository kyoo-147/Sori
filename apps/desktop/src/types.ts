...
export interface BenchmarkResult { runId?: string; startedAt?: string; completedAt?: string; modelId: string; provider?: string; modelName: string; samples?: number; attempts?: number; coldStartMs: number | null; warmLatencyMs: number | null; p50Ms?: number | null; p95Ms?: number | null; ramMb: number | null; vramMb?: number | null; werPercent: number | null; cerPercent?: number | null; rtf: number | null; failureRate?: number | null; fallbackRate?: number | null; insertionMs: number | null; passed: boolean; isRecommended?: boolean; }
