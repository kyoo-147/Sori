  ...
  return (
    <main className="sori-screen sori-page-layout min-w-0" aria-busy={running}>
      ...
      <div className="grid min-w-0 gap-5 lg:grid-cols-[0.9fr_1.1fr]">
        <section className="sori-pane min-w-0 space-y-5 px-2.5 py-2.5" aria-labelledby="benchmark-execution-heading">
        ...
        <section className="sori-pane min-w-0 space-y-4 px-2.5 py-2.5" aria-labelledby="persisted-results-heading">
