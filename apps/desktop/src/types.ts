...
export interface ModelRecord { id: string; name: string; provider: string; location: 'local' | 'cloud'; qualityTier: 'low' | 'standard' | 'high' | 'ultra'; recommended: boolean; available: boolean; unavailableReason: string | null; installed?: boolean; loaded?: boolean; warm?: boolean; }
