/**
 * Sori Design System — System Design & Token Architecture
 *
 * Design Philosophy:
 * - Mostly neutral, low saturation, soft contrast
 * - Color for meaning, not decoration
 * - Soft accent brand-neutral blue gray (#EEF2F6 / #5C728A) preferred over heavy black buttons
 * - Light glass surfaces for overlays, tray, floating controls, top utility capsules
 */
...
export const systemDesignTokens = {
  ...
  glass: {
    light: {
      ...
      border: '1px solid rgba(210, 214, 220, 0.72)',
      boxShadow: '0 8px 30px rgba(0, 0, 0, 0.04), inset 0 1px 0 rgba(255, 255, 255, 0.65)',
    },
    strong: {
      bg: 'rgba(255, 255, 255, 0.76)',
      backdropFilter: 'blur(24px) saturate(130%)',
      border: '1px solid rgba(203, 208, 214, 0.86)',
