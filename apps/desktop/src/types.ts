...
export interface ModelRecord { id: string; name: string; provider: string; location: 'local' | 'cloud'; qualityTier: 'low' | 'standard' | 'high' | 'ultra'; recommended: boolean; available: boolean; unavailableReason: string | null; installed?: boolean; loaded?: boolean; warm?: boolean; source?: string | null; sha256?: string | null; license?: string | null; }
export interface BenchmarkProvenance { manifestVersion: number | null; evidenceClass: 'deterministic-test' | 'real-provider-fixture' | 'native-device' | null; audioSha256: string | null; audioBytes: number | null; audioDurationSeconds: number | null; sampleRateHz: number | null; channels: number | null; referenceSha256: string | null; referenceAbsentReason: string | null; sourceCommit: string | null; modelSha256?: string | null; runtimeSha256?: string | null; inputFingerprint?: string | null; unavailableReasons?: string[]; }
export interface BenchmarkResult { runId?: string | null; startedAt?: string | null; completedAt?: string | null; modelId: string; provider?: string | null; modelName: string; samples?: number | null; attempts?: number | null; coldStartMs: number | null; warmLatencyMs: number | null; p50Ms?: number | null; p95Ms?: number | null; ramMb: number | null; vramMb?: number | null; werPercent: number | null; cerPercent?: number | null; rtf: number | null; failureRate?: number | null; fallbackRate?: number | null; insertionMs?: number | null; passed?: boolean; isRecommended?: boolean; provenance?: BenchmarkProvenance; }
