...
export const Navbar: React.FC<NavbarProps> = ({
  ...
  const navItems: { id: ActiveScreen; label: string; icon: React.ReactNode; level: UserLevel }[] = [
    { id: 'playground', label: 'Dictation & Home', icon: <Mic className="w-4 h-4" />, level: 'basic' },
    { id: 'transcripts', label: 'History & Audit Logs', icon: <FileCode2 className="w-4 h-4" />, level: 'basic' },
    { id: 'onboarding', label: 'First Run Wizard', icon: <CheckCircle2 className="w-4 h-4" />, level: 'basic' },
    { id: 'voice-edit', label: 'Voice Selection Edit', icon: <FileCode2 className="w-4 h-4" />, level: 'basic' },
    { id: 'models', label: 'Model Engine & Router', icon: <Cpu className="w-4 h-4" />, level: 'advanced' },
    { id: 'benchmarks', label: 'Auto Benchmark Suite', icon: <Zap className="w-4 h-4" />, level: 'advanced' },
    { id: 'dictionary', label: 'Vocabulary & Snippets', icon: <BookOpen className="w-4 h-4" />, level: 'basic' },
    { id: 'extensions', label: 'Extensions & Sandbox', icon: <Code className="w-4 h-4" />, level: 'advanced' },
    { id: 'system-design', label: 'System Architecture', icon: <Layers className="w-4 h-4" />, level: 'expert' },
    { id: 'settings', label: 'Settings & Profiles', icon: <Sliders className="w-4 h-4" />, level: 'basic' },
    { id: 'privacy', label: 'Privacy & Retention', icon: <Shield className="w-4 h-4" />, level: 'expert' },
    { id: 'diagnostics', label: 'Sori Doctor Check', icon: <CheckCircle2 className="w-4 h-4" />, level: 'basic' },
  ];
