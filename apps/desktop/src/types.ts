...
export interface BenchmarkProvenance { manifestVersion: number | null; evidenceClass: 'deterministic-test' | 'real-provider-fixture' | 'native-device' | null; audioSha256: string | null; audioBytes: number | null; audioDurationSeconds: number | null; sampleRateHz: number | null; channels: number | null; referenceSha256: string | null; referenceAbsentReason: string | null; sourceCommit: string | null; }
