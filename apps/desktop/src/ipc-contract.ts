...
export type IpcRequest =
  ...
  | { RecentEvents: { limit: number } } | { ResourceGet: { resource: string } } | { ResourceSet: { resource: string; value: unknown } } | { ResourceDelete: { resource: string } } | { RecentHistory: { limit: number } } | { DeleteHistory: { id: string } } | { SettingGet: { key: string } } | { SettingDelete: { key: string } } | { SetConfig: { key: string; value: unknown } } | { Dictation: { model: string; audio: AudioChunk[] } }
