...
export function requestShape(operation: IpcOperation, params: Record<string, unknown> = {}): IpcRequest {
  switch (operation) {
    ...
    case 'dictation_start': return 'DictationStart'; case 'dictation_stop': return 'DictationStop'; case 'dictation_cancel': return 'DictationCancel'; case 'dictation_audio': return { DictationAudio: { model: String(params.model ?? ''), audio: (params.audio ?? []) as AudioChunk[] } };
